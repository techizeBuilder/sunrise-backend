        ...
        <div className="container-max">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <h3 className="text-xl text-subheading mb-3">Quality First</h3>
              <p className="text-muted-foreground">
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl text-subheading mb-3">Innovation</h3>
              <p className="text-muted-foreground">
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl text-subheading mb-3">Customer Care</h3>
              <p className="text-muted-foreground">
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl text-subheading mb-3">Team Spirit</h3>
              <p className="text-muted-foreground">
