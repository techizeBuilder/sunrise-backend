  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="section-padding bg-muted/30">
        <div className="container-max">
          <div className="text-center mb-12 sm:mb-16">
            <h2 className="text-2xl sm:text-3xl lg:text-4xl text-heading mb-3 sm:mb-4">Get in Touch</h2>
            <p className="text-base sm:text-lg text-muted-foreground px-4">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            <div className="text-center px-4">
              ...
              <h3 className="text-lg sm:text-xl text-subheading mb-2 sm:mb-3">Phone</h3>
              <p className="text-sm sm:text-base text-muted-foreground">+91 9876543210</p>
              <p className="text-sm sm:text-base text-muted-foreground">+91 9876543211</p>
            </div>
            ...
            <div className="text-center px-4">
              ...
              <h3 className="text-lg sm:text-xl text-subheading mb-2 sm:mb-3">Email</h3>
              <p className="text-sm sm:text-base text-muted-foreground">info@sunrisefoods.com</p>
              <p className="text-sm sm:text-base text-muted-foreground">sales@sunrisefoods.com</p>
            </div>
            ...
            <div className="text-center px-4">
              ...
              <h3 className="text-lg sm:text-xl text-subheading mb-2 sm:mb-3">Headquarters</h3>
              <p className="text-sm sm:text-base text-muted-foreground">Sunrise Foods Pvt. Ltd.</p>
              <p className="text-sm sm:text-base text-muted-foreground">Hyderabad, Telangana</p>
            </div>
          </div>
        </div>
      </section>
